...
#define LIMIT int(5e6+6)
bool is_prime[LIMIT+1];
vector<int> prime, Deprime;
...
void precal() {
	...
	sort(Deprime.begin(), Deprime.end());
}
...
int main()
{
    ...
    precal();
  	...
  	while (true) {
  		...
  		if (a==0) break;
  		cin>>b;
  		int ans = upper_bound(Deprime.begin(), Deprime.end(), b) - lower_bound(Deprime.begin(), Deprime.end(), a);
  		cout<<ans<<endl;
  	}
