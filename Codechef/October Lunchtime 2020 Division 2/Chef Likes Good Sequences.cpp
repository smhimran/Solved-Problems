     ...
     freopen("out.txt", "w", stdout);
  	...
  	while (t--) {
  		...
  		while (q--) {
  			...
  			cin>>x>>y;
  			LL now = a[x];
  			bool left = 0, right = 0, c_right = 0, c_left = 0;
  			...
  			// debug(a[x]);
  			// debug(left, right, c_left, c_right);

  			if ((!left and !right) and (c_right and c_left))
  				ans -= 2;
  			else if ((!left and !right) and (c_right or c_left))
  				ans--;
  			else if ((left and right) and (!c_right and !c_left))
  				ans += 2;
  			else if ((left or right) and (!c_right and !c_left))
  				ans++;
